    ...
    try:
        if which == "sv":
            ...
            if not ddsim_available():
                ...
                return {"ok": False, "backend": "dd", "error": "mqt.ddsim not available", "elapsed_s": 0.0, "estimate": est}
